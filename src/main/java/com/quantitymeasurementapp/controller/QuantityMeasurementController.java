...
public class QuantityMeasurementController {
    ...
    // @Valid on QuantityDTO -> validates value (NotNull) and unit (NotBlank)
    @PostMapping("/compare")
    public ResponseEntity<Map<String, Object>> compareQuantities(
    ...
    @PostMapping("/add")
    public ResponseEntity<QuantityDTO> addQuantities(
            @RequestBody Map<String, @Valid QuantityDTO> body) {
        QuantityDTO a = body.get("thisQuantity");
        QuantityDTO b = body.get("thatQuantity");
    ...
    public ResponseEntity<QuantityDTO> subtractQuantities(
            @RequestBody Map<String, @Valid QuantityDTO> body) {
        QuantityDTO a = body.get("thisQuantity");
        QuantityDTO b = body.get("thatQuantity");
    ...
    @PostMapping("/divide")
    public ResponseEntity<Map<String, Object>> divideQuantities(
            @RequestBody Map<String, @Valid QuantityDTO> body) {
        QuantityDTO a = body.get("thisQuantity");
        QuantityDTO b = body.get("thatQuantity");
